			...
			<section class="avada-db-card">
				<div class="fusion-builder-option">
					<div class="fusion-builder-option-title">
						...
						<span class="fusion-builder-option-label">
							<p><?php esc_html_e( 'Choose to export Avada Builder Library content. You can export your saved containers, columns and elements, or your saved full page templates. A corresponding XML file will be downloaded to your computer.', 'fusion-builder' ); ?></p>
						</span>
					</div>
