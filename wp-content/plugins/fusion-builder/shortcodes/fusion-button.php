			...
			public function add_options() {
				...
				return [
					'button_shortcode_section' => [
						...
						'fields' => [
							'button_padding'               => [
								'label'       => esc_html__( 'Button Padding', 'fusion-builder' ),
								'description' => esc_html__( 'Controls the padding for buttons.', 'fusion-builder' ),
								'id'          => 'button_padding',
								'choices'     => [
									'top'    => true,
									'right'  => true,
							...
							'button_presets'               => [
								'label'       => esc_html__( 'Legacy Button Presets', 'fusion-builder' ),
								'description' => esc_html__( 'Select if you would like to enable legacy color presets.', 'fusion-builder' ),
								'id'          => 'button_presets',
								'default'     => '0',
								'type'        => 'switch',
