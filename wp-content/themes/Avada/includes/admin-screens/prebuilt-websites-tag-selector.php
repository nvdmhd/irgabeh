...
<div class="avada-importer-tags-selector">
	...
	<ul>
        ...
        <!--nikan-->
        <?php if ( isset($count_tags['persian']) ) { ?>
            <li data-tag="persian">
                <button class="button avada-db-demos-filter avada-db-demos-filter-persian" data-tag="persian" data-count="<?php echo esc_attr( absint( $count_tags['persian'] ) ); ?>">
                    <span class="avada-db-demos-filter-text">فارسی</span>
                    <span class="count">(<?php echo esc_html( absint( $count_tags['persian'] ) ); ?>)</span>
                </button>
            </li>
            <?php unset($count_tags['persian']); } ?>
        <!--nikan-->
