	...
	<div id="theme-demo-<?php echo esc_attr( strtolower( $demo ) ); ?>" class="theme">
		<div class="theme-wrapper">
			...
			<div class="theme-actions">
                ...
                <?php //nikan
                if ( $is_persian ) {
                    $preview_url = 'https://avada.ir/demos/' . str_replace( '_', '-', $demo );
                }
                //nikan?>
            ...
            <?php //nikan
            if ( $is_persian ) {
                echo '<div class="plugin-required" style="display: block;background: rgba(232, 46, 15, 0.95);left: auto;right: 0.7em;">فارسی</div>';
            } //nikan
            ?>
		</div>
