			...
			<div class="color-confirm">
				...
				<div class="awb-setup-wizard-style-preview color-preview typo-card awb-setup-wizard-allow-invert">
					<div class="awb-setup-wizard-content-preview-wrapper">
                        ...
                        <p>طراحان سایت هنگام طراحی قالب سایت معمولا با این موضوع رو برو هستند که محتوای اصلی صفحات آماده نیست. در نتیجه طرح کلی دید درستی به کار فرما نمیدهد.</p>
		...
		<div class="awb-setup-wizard-content awb-setup-wizard-content-secondary">
			<div id="typo-selection">
				...
				$typo_translations = [
                    ...
                    'text1'       => 'طراحان سایت هنگام طراحی قالب سایت معمولا با این موضوع رو برو هستند که محتوای اصلی صفحات آماده نیست. در نتیجه طرح کلی دید درستی به کار فرما نمیدهد.',
                    'text2'       => 'طراحان سایت هنگام طراحی قالب سایت معمولا با این موضوع رو برو هستند که محتوای اصلی صفحات آماده نیست.',
			...
			<div class="awb-setup-wizard-typography-preview-wrapper">
				...
				<div class="awb-setup-wizard-style-preview awb-setup-wizard-style-preview-typography typography awb-setup-wizard-allow-invert">
					...
					<div class="awb-typo-right-side">
                        ...
                        <hr>
                        <span>اگر شما یک طراح هستین و یا با طراحی های گرافیکی سروکار دارید به متن های برخورده اید</span>
						<a class="button"><?php esc_html_e( 'Sample Button', 'Avada' ); ?></a>
					</div>
