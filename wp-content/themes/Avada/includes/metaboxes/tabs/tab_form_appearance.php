	...
	$sections['form_appearance'] = [
		...
		'fields'   => [
			'preview_width'            => [
				...
				'description' => __( 'Select the width to preview the form at in the live editor. <strong>NOTE:</strong> This is only used for previewing purposes.', 'Avada' ),
				'id'          => 'preview_width',
				'dependency'  => [],
				'type'        => 'slider',
			...
			'preview_background_color' => [
				'type'        => 'color-alpha',
				'label'       => esc_html__( 'Preview Background Color', 'Avada' ),
				'description' => __( 'Choose a background color for the form preview in live editor. <strong>NOTE:</strong> This is only used for previewing purposes.', 'Avada' ),
			...
			'label_position'           => [
				...
				'label'       => esc_html__( 'Label Position', 'Avada' ),
			...
			'label_font_size'          => [
				'type'        => 'text',
				'label'       => esc_html__( 'Label Font Size', 'Avada' ),
				/* translators: Additional description (defaults). */
			...
			'tooltip_text_color'       => [
				'type'        => 'color-alpha',
				'label'       => esc_html__( 'Tooltip Text Color', 'Avada' ),
				'description' => esc_html__( 'Controls the text color of the field tooltip.', 'Avada' ),
			...
			'tooltip_background_color' => [
				'type'        => 'color-alpha',
				'label'       => esc_html__( 'Tooltip Background Color', 'Avada' ),
				'description' => esc_html__( 'Controls the background color of the field tooltip.', 'Avada' ),
			...
			'field_margin'             => [
				'type'             => 'dimensions',
				'label'            => esc_html__( 'Field Margin', 'Avada' ),
				...
				'dependency'       => [],
				'description'      => esc_html__( 'Controls the vertical height between form fields. In pixels (px), ex: 10px.', 'Avada' ),
				'transport'        => 'postMessage',
				'events'           => [
					'fusion-form-styles',
				],
			...
			'form_input_height'        => [
				'type'        => 'text',
				'label'       => esc_html__( 'Field Height', 'Avada' ),
				/* translators: Additional description (defaults). */
			...
			'form_font_size'           => [
				'type'        => 'text',
				'label'       => esc_html__( 'Field Font Size', 'Avada' ),
				/* translators: Additional description (defaults). */
			...
			'form_bg_color'            => [
				'type'        => 'color-alpha',
				'label'       => esc_html__( 'Field Background Color', 'Avada' ),
				/* translators: Additional description (defaults). */
			...
			'form_text_color'          => [
				'type'        => 'color-alpha',
				'label'       => esc_html__( 'Field Text Color', 'Avada' ),
				/* translators: Additional description (defaults). */
			...
			'form_label_color'         => [
				'type'        => 'color-alpha',
				'label'       => esc_html__( 'Field Label Color', 'Avada' ),
				/* translators: Additional description (defaults). */
			...
			'form_placeholder_color'   => [
				'type'        => 'color-alpha',
				'label'       => esc_html__( 'Field Placeholder Color', 'Avada' ),
				/* translators: Additional description (defaults). */
			...
			'form_border_width'        => [
				'type'        => 'dimensions',
				'label'       => esc_html__( 'Field Border Size', 'Avada' ),
				/* translators: Additional description (defaults). */
			...
			'form_border_color'        => [
				'type'        => 'color-alpha',
				'label'       => esc_html__( 'Field Border Color', 'Avada' ),
				/* translators: Additional description (defaults). */
			...
			'form_border_radius'       => [
				'type'        => 'slider',
				'label'       => esc_html__( 'Field Border Radius', 'Avada' ),
				/* translators: Additional description (defaults). */
