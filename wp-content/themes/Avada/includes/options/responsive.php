	...
	$sections['mobile'] = [
		...
		'fields'   => [
			...
			'visibility_small'                          => [
				...
				'description' => esc_html__( 'Controls when the small screen options and visibility should take effect.', 'Avada' ),
				'id'          => 'visibility_small',
				'default'     => '640',
				'type'        => 'slider',
				'choices'     => [
			...
			'visibility_medium'                         => [
				...
				'description' => esc_html__( 'Controls when the medium screen options and visibility should take effect.', 'Avada' ),
			...
			'visibility_large'                          => [
				...
				'description' => esc_html__( 'Any screen larger than that which is defined as the medium screen will be counted as a large screen.', 'Avada' ),
				'id'          => 'visibility_large',
				'full_width'  => false,
				'type'        => 'raw',
