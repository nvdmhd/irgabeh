...
function avada_options_section_blog( $sections ) {
	...
	$blog_general_options = [
		...
		'fields'      => [
			...
			'dates_box_color'                              => [
				'label'       => esc_attr__( 'Blog Alternate Layout Date Box Color', 'Avada' ),
				'description' => esc_attr__( 'Controls the color of the date box in blog alternate and recent posts layouts.', 'Avada' ),
				'id'          => 'dates_box_color',
