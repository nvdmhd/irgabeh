...
class Fusion_App {
	...
	public function live_scripts( $hook ) {
        ...
        if ( is_rtl() ) {
            wp_enqueue_style( 'fusion-app-builder-frame-css-rtl', FUSION_LIBRARY_URL . '/inc/fusion-app/css/fusion-builder-frame-rtl.min.css', [], $fusion_library_latest_version );
        }
